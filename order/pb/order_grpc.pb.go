...
const (
	OrdersService_PostOrder_FullMethodName           = "/pb.OrdersService/PostOrder"
	OrdersService_GetOrdersForAccount_FullMethodName = "/pb.OrdersService/GetOrdersForAccount"
)
...
type OrdersServiceClient interface {
	...
	GetOrdersForAccount(ctx context.Context, in *GetOrdersForAccountRequest, opts ...grpc.CallOption) (*GetOrderForAccountResponse, error)
}
...
func (c *ordersServiceClient) GetOrdersForAccount(ctx context.Context, in *GetOrdersForAccountRequest, opts ...grpc.CallOption) (*GetOrderForAccountResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetOrderForAccountResponse)
	err := c.cc.Invoke(ctx, OrdersService_GetOrdersForAccount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrdersServiceServer interface {
	...
	GetOrdersForAccount(context.Context, *GetOrdersForAccountRequest) (*GetOrderForAccountResponse, error)
...
func (UnimplementedOrdersServiceServer) GetOrdersForAccount(context.Context, *GetOrdersForAccountRequest) (*GetOrderForAccountResponse, error) {
...
func _OrdersService_GetOrdersForAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetOrdersForAccountRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrdersServiceServer).GetOrdersForAccount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrdersService_GetOrdersForAccount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrdersServiceServer).GetOrdersForAccount(ctx, req.(*GetOrdersForAccountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrdersService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _OrdersService_GetOrdersForAccount_Handler,
		},
	},
